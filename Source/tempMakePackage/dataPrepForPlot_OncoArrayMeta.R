...
# plot for Oncoarray New Regions
...
regionSelected <- regionSelected[ regions$DATA == "OncoArrayNewHits"]

# Loop and plot -----------------------------------------------------------
for(i in regionSelected) {
#for(i in c("chrX_10983000_11984000","chrX_50141000_51142000")){
  #define region vars
  #i = regionSelected[3]
  regionTitle = i
  regionName = i
  ...
  regionStartZoom = min(assoc$BP, na.rm = TRUE)
  regionEndZoom =   max(assoc$BP, na.rm = TRUE)
